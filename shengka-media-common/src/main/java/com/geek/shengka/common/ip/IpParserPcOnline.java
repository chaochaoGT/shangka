 ...
 */
public class IpParserPcOnline implements IpPareser {

	protected static Logger logger = LoggerFactory.getLogger(IpParserPcOnline.class);

	private final static String REMOTE_URL = "http://whois.pconline.com.cn/ip.jsp?ip=";

	private static IpParserPcOnline INSTANCE = new IpParserPcOnline();
	private IpParserPcOnline(){}
	protected static IpParserPcOnline instance() {
		return INSTANCE;
	}
	...
	public static void main(String[] args) throws Exception {
		String ipLookup = new IpParserPcOnline().ipLoc("119.139.196.127"); // baidu.com IP地址 //ipInfos 是一个数组
