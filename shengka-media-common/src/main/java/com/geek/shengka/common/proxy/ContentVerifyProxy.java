...
@Component
@Data
public class ContentVerifyProxy {
	private static final Logger logger = LoggerFactory.getLogger(ContentVerifyProxy.class);


	private static final String CONTENT_KEY = "CONTENT:VERIFY:AUTH:%s";
