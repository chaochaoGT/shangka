 ...
 */
@Data
@ApiModel(description = "新增宝箱配置")
public class SkTreasureBoxConfigAddReqParam implements Serializable {
    private static final long serialVersionUID = 3226614840865099468L;
    /**
     * 宝箱活动名称
     */
